...
// 		if(frm.doc.production_plan && !frm.doc.material_request) {
// 			frappe.call({
// 			method: "frappe.client.get",
// 			args: {
...
// 			callback: function(r) {
// 				if(r.message) {
// 					var material_request = r.message.material_requests;
// 					if(material_request && material_request.length > 0) {
// 					frm.set_value('material_request', material_request[0].material_request);
// 					} else {
// 					frappe.msgprint(__('No Material Request found in the selected Production Plan.'));
// 					}
// 				} else {
// 					frappe.msgprint(__('No Production Plan found with the selected name.'));
// 				}
// 			}
// 			});
// 		}
